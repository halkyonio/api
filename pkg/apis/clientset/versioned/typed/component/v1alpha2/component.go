...
func newComponents(c *DevexpV1alpha2Client, namespace string) *components {
	return &components{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *components) Get(name string, options v1.GetOptions) (result *v1alpha2.Component, err error) {
	result = &v1alpha2.Component{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("components").
		Name(name).
...
func (c *components) List(opts v1.ListOptions) (result *v1alpha2.ComponentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.ComponentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) Create(component *v1alpha2.Component) (result *v1alpha2.Component, err error) {
	result = &v1alpha2.Component{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) Update(component *v1alpha2.Component) (result *v1alpha2.Component, err error) {
	result = &v1alpha2.Component{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) UpdateStatus(component *v1alpha2.Component) (result *v1alpha2.Component, err error) {
	result = &v1alpha2.Component{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("components").
...
func (c *components) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Component, err error) {
	result = &v1alpha2.Component{}
