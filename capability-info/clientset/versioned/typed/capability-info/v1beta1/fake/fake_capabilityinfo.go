...
func (c *FakeCapabilityInfos) Get(name string, options v1.GetOptions) (result *v1beta1.CapabilityInfo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(capabilityinfosResource, name), &v1beta1.CapabilityInfo{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeCapabilityInfos) List(opts v1.ListOptions) (result *v1beta1.CapabilityInfoList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(capabilityinfosResource, capabilityinfosKind, opts), &v1beta1.CapabilityInfoList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeCapabilityInfos) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(capabilityinfosResource, opts))
}
...
func (c *FakeCapabilityInfos) Create(capabilityInfo *v1beta1.CapabilityInfo) (result *v1beta1.CapabilityInfo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(capabilityinfosResource, capabilityInfo), &v1beta1.CapabilityInfo{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.CapabilityInfo), err
...
func (c *FakeCapabilityInfos) Update(capabilityInfo *v1beta1.CapabilityInfo) (result *v1beta1.CapabilityInfo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(capabilityinfosResource, capabilityInfo), &v1beta1.CapabilityInfo{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.CapabilityInfo), err
...
func (c *FakeCapabilityInfos) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(capabilityinfosResource, name), &v1beta1.CapabilityInfo{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeCapabilityInfos) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(capabilityinfosResource, listOptions)
...
func (c *FakeCapabilityInfos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CapabilityInfo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(capabilityinfosResource, name, pt, data, subresources...), &v1beta1.CapabilityInfo{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.CapabilityInfo), err
