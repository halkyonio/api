...
func (in *CapabilitiesConfig) DeepCopyInto(out *CapabilitiesConfig) {
	*out = *in
	if in.Requires != nil {
		...
		*out = make([]RequiredCapabilityConfig, len(*in))
		for i := range *in {
	...
	if in.Provides != nil {
		...
		*out = make([]CapabilityConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RequiredCapabilityConfig) DeepCopyInto(out *RequiredCapabilityConfig) {
	*out = *in
	in.CapabilityConfig.DeepCopyInto(&out.CapabilityConfig)
	return
}
...
func (in *RequiredCapabilityConfig) DeepCopy() *RequiredCapabilityConfig {
	...
	out := new(RequiredCapabilityConfig)
	in.DeepCopyInto(out)
	return out
}
