...
import (
	...
	scheme "halkyon.io/api/component/clientset/versioned/scheme"
	v1beta1 "halkyon.io/api/component/v1beta1"
...
type ComponentInterface interface {
	...
	UpdateStatus(*v1beta1.Component) (*v1beta1.Component, error)
...
func newComponents(c *HalkyonV1beta1Client, namespace string) *components {
	return &components{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *components) UpdateStatus(component *v1beta1.Component) (result *v1beta1.Component, err error) {
	result = &v1beta1.Component{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("components").
