...
import (
	...
	scheme "halkyon.io/api/link/clientset/versioned/scheme"
	v1beta1 "halkyon.io/api/link/v1beta1"
...
type LinkInterface interface {
	Create(*v1beta1.Link) (*v1beta1.Link, error)
	Update(*v1beta1.Link) (*v1beta1.Link, error)
	UpdateStatus(*v1beta1.Link) (*v1beta1.Link, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Link, error)
	List(opts v1.ListOptions) (*v1beta1.LinkList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Link, err error)
	LinkExpansion
}
...
func newLinks(c *HalkyonV1beta1Client, namespace string) *links {
	return &links{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *links) Get(name string, options v1.GetOptions) (result *v1beta1.Link, err error) {
	result = &v1beta1.Link{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("links").
...
func (c *links) List(opts v1.ListOptions) (result *v1beta1.LinkList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.LinkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("links").
...
func (c *links) Create(link *v1beta1.Link) (result *v1beta1.Link, err error) {
	result = &v1beta1.Link{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("links").
...
func (c *links) Update(link *v1beta1.Link) (result *v1beta1.Link, err error) {
	result = &v1beta1.Link{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("links").
...
func (c *links) UpdateStatus(link *v1beta1.Link) (result *v1beta1.Link, err error) {
	result = &v1beta1.Link{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("links").
...
func (c *links) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Link, err error) {
	result = &v1beta1.Link{}
